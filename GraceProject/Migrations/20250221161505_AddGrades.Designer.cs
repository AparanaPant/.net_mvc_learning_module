...
namespace GraceProject.Migrations
{
    ...
    [Migration("20250221161505_AddGrades")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraceProject.Models.CourseEducator", b =>
                {
                    b.Property<string>("CourseID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CourseEducator");
                });

            modelBuilder.Entity("GraceProject.Models.EducatorGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraceProject.Models.Grade", b =>
                {
                    b.Property<int>("GradeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraceProject.Models.EducatorGrade", b =>
                {
                    b.HasOne("GraceProject.Models.Educator", "Educator")
                        .WithMany("EducatorGrades")
                        .HasForeignKey("EducatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GraceProject.Models.Grade", "Grade")
                        .WithMany("EducatorGrades")
